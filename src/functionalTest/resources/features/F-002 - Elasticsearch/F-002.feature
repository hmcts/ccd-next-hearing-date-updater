...
#-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  Scenario: Update cases in Elasticsearch
    ...
    Then a successful call [to verify next hearing date for Case1] as in [F-002_Verify_Case1]
    Then a successful call [to verify next hearing date for Case2] as in [F-002_Verify_Case2]
    Then a successful call [to verify next hearing date for Case3] as in [F-002_Verify_Case3]
